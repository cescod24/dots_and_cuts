#!/usr/bin/env python3
"""
Training Analysis for RL V2 (Enhanced Double DQN with Reward Shaping)

Generates visualization and statistics for V2 training performance.
"""
...
def analyze_training_v2():
    """Load and analyze V2 training log."""
    print("Loading RL V2 training data...")
    ...
    fig.suptitle('RL V2 Training Analysis (Enhanced Double DQN with Reward Shaping)\n512-256-128-64-1 Network', 
    ...
    plt.tight_layout()
    plt.savefig('training_analysis_v2.png', dpi=150, bbox_inches='tight')
    print("✓ Saved: training_analysis_v2.png")
    
    # Print statistics
    print("\n" + "="*60)
    print("RL V2 TRAINING STATISTICS")
    print("="*60)
